...
function instantiateArrayBuffer(binaryFile, imports, receiver) {
  return WXWebAssembly.instantiate('main.wasm', imports)
    .then((instance) => {
      err(`加载成功`);
      return instance
    })
...
// end include: preamble.js
  ...
  var _emscripten_get_now;
      ...
      _emscripten_get_now = () => new Date().getTime();
  ;
...
var _yinPitchEstimation = Module['_yinPitchEstimation'] = createExportWrapper('yinPitchEstimation', 3);
var _calculateIntensity = Module['_calculateIntensity'] = createExportWrapper('calculateIntensity', 2);
